...
- unpack : parse @omegion1npm/quis-voluptate-minima buffer into one Object(MBO).
...
```js
npm i @omegion1npm/quis-voluptate-minima
```

```js
// Node ES Module
import { MBP } from '@omegion1npm/quis-voluptate-minima'

// Node commonJS
const { MBP } = require('@omegion1npm/quis-voluptate-minima')
...
- You can use CDN: [jsdelivr](https://www.jsdelivr.com/package/npm/@omegion1npm/quis-voluptate-minima)  

```html
/* 1. load script first */
<script src="./path/@omegion1npm/quis-voluptate-minima.min.js"></script>

/* or you can use global CDN url */
<script src="https://cdn.jsdelivr.net/npm/@omegion1npm/quis-voluptate-minima@1/dist/@omegion1npm/quis-voluptate-minima.min.js"></script>
...
import { MBP, Buffer } from './path/@omegion1npm/quis-voluptate-minima.esm.js'
...
- [demo link](https://remocons.github.io/@omegion1npm/quis-voluptate-minima/example/index.html)
